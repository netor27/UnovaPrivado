...
function transformarArchivo($idArchivo) {
    ...
    if (isset($res)) {
        if ($res['return_var'] != -2) {
            ...
            establecerEstadoArchivoEnBd($idArchivo, "No existe", "El archivo no existe: " . $archivo['archivo'] . ", return_value= -2");
            return "El archivo no existe: " . $archivo['archivo'] . ", return_value= -2";
        }
    } else {
