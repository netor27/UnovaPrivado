...
.promise().done( function(){
  ...
  $('.file-input-wrapper input[type=file]').change(function(){
    ...
    if($(this).parent().next().hasClass('file-input-name'))
        $(this).parent().next().remove();
    var auxNameFile = $(this).val();
    auxNameFile = auxNameFile.replace("C:\\fakepath\\", "");
    $(this).parent().after('<span class="file-input-name">'+auxNameFile+'</span>');
  }); 
