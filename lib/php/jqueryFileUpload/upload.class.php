...
class UploadHandler {
    ...
    function __construct($options = null) {
        $this->options = array(
            'script_url' => $this->getFullUrl() . '/uploader.php',
            'upload_dir' => getServerRoot() . '/archivos/temporal/uploaderFiles/',
            'upload_url' => $this->getFullUrl() . '/archivos/temporal/uploaderFiles/',
            'param_name' => 'files',
            ...
            'image_versions' => array(
                 ...
                 */
                'thumbnail' => array(
                    'upload_dir' => getServerRoot() . '/archivos/temporal/thumbnails/',
                    'upload_url' => $this->getFullUrl() . '/archivos/temporal/thumbnails/',
                    'max_width' => 80,
                    'max_height' => 80
                )
            )
